	...
	if(!empty(jQuery(".anexo"))){
		new AjaxUpload('file-original', {
			...
			onComplete : function(file,response){
				...
				input2 = "<input name='panexo_arquivo_titulo[]' id='panexo_arquivo_titulo' readonly='readonly' type='text' value='" + file + "' class='attach xml' style='width: 600px;' />";
