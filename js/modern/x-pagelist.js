    ...
    $.extend($.fn, {
        pagelist: function () {
            ...
            this.click = function (pageList, page) {
                ...
                var par = pageList.paramCallback.replace('{page}', page);
                if(pageList.execCallback != null) {
                    this.execCallback(par);
                } else if (pageList.ajax != null) {
                    $.ajax({
                        url: url,
                        async: true,
    ...
    function rebuildPage(pageContent, previousContent, nextContent, jumpContent, pagelist) {
        ...
        if (jumpContent != null) {
            ...
            pageGo.click(function () {
                var result = pagelist.navigateTo(pageGoValue.val());console.log("pagelist.navigateTo: ", result);
                if (result == false) {
                    /*$.Dialog({
                        'title': 'Jump Page',
                    ...
                    alertify.alert('Aviso', 'Valor errado, informe um indice correto !');
                    return false;
                }
            });
        }
